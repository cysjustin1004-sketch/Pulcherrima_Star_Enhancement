...
const TRACKS = {
  track1: [
    { level: 14, name: '적색왜성', subname: '프록시마 센타우리', type: 'M형 적색왜성',
      ...
      drop: { key: ITEM_KEYS.MAGNETAR_FLARE, min: 1, max: 3 },
    ...
    { level: 15, name: '플레어별', subname: 'TRAPPIST-1 급', type: '활동성 적색왜성',
      ...
      drop: { key: ITEM_KEYS.HAWKING, min: 1, max: 3 },
...
const SHOP_ITEMS = [
  {
    id: 'warp_9',
    name: '+9강 도약권',
    desc: 'FU 오리온 폭발(+9) 상태로 시작합니다. (성공 확률 1/3, 실패 시 수소만 소모)',
    price: 800000,
    type: 'warp',
    targetLevel: 9,
  },
  {
    id: 'warp_13',
    name: '+13강 도약권',
    desc: '중심 수소 고갈(+13) 상태로 시작합니다. (성공 확률 1/3, 실패 시 수소만 소모)',
    price: 5000000,
    type: 'warp',
    targetLevel: 13,
  },
  {
    id: 'warp_14',
    name: '+14강 도약권',
    desc: '트랙 진입 직후(+14) 상태로 시작합니다. 트랙은 무작위로 배정됩니다. (성공 확률 1/3, 실패 시 수소만 소모)',
    price: 7500000,
    type: 'warp',
    targetLevel: 14,
  },
  {
    id: 'warp_15',
    name: '+15강 도약권',
    desc: '트랙 두 번째 단계(+15) 상태로 시작합니다. 트랙은 무작위로 배정됩니다. (성공 확률 1/3, 실패 시 수소만 소모)',
    price: 10000000,
    type: 'warp',
    targetLevel: 15,
  },
