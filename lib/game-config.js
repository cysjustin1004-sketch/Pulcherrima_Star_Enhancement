...
const COMMON_STAGES = [
  ...
  { level:15, name:'적색거성가지 진입',    cost:{type:'hydrogen',amount:130000}, successRate:0.46, sellPrice:10000000,protectionCost:4, drop:{key:ITEM_KEYS.HAWKING,         min:1,max:3} },
...
const TRACKS = {
  track1: [
    { level:17, name:'적색왜성',        cost:{type:'hydrogen',amount:220000}, successRate:0.40, sellPrice:44500000,  protectionCost:9,  drop:null },
    { level:18, name:'플레어별',        cost:{type:'hydrogen',amount:300000}, successRate:0.38, sellPrice:72000000,  protectionCost:10, drop:null },
    { level:19, name:'초장수명 주계열', cost:{type:'hydrogen',amount:400000}, successRate:0.35, sellPrice:120000000, protectionCost:12, drop:null },
    { level:20, name:'청색왜성化',      cost:{type:'hydrogen',amount:650000}, successRate:0.33, sellPrice:240000000, protectionCost:15, drop:null },
    { level:21, name:'청색왜성',        cost:{type:'star',level:19,amount:1}, successRate:0.30, sellPrice:300000000, protectionCost:17, drop:null },
    { level:22, name:'헬륨 백색왜성',   cost:{type:'star',level:21,amount:2}, successRate:0.27, sellPrice:400000000, protectionCost:20, drop:null },
    { level:23, name:'백색왜성 냉각',   cost:{type:'item',key:ITEM_KEYS.MAGNETAR_FLARE,amount:12}, successRate:0.27, sellPrice:550000000, protectionCost:22, drop:null },
    { level:24, name:'흑색왜성',        cost:{type:'star',level:22,amount:1}, successRate:0.25, sellPrice:750000000, protectionCost:23, drop:null },
  ],
  track2: [
    { level:17, name:'적색거성',        cost:{type:'hydrogen',amount:220000}, successRate:0.40, sellPrice:44500000,  protectionCost:9,  drop:null },
    { level:18, name:'헬륨 섬광',       cost:{type:'hydrogen',amount:300000}, successRate:0.38, sellPrice:72000000,  protectionCost:10, drop:null },
    { level:19, name:'수평가지',        cost:{type:'hydrogen',amount:400000}, successRate:0.35, sellPrice:120000000, protectionCost:12, drop:null },
    { level:20, name:'점근거성가지',    cost:{type:'hydrogen',amount:650000}, successRate:0.33, sellPrice:240000000, protectionCost:15, drop:null },
    { level:21, name:'후-AGB 초바람',   cost:{type:'star',level:19,amount:1}, successRate:0.30, sellPrice:300000000, protectionCost:17, drop:null },
    { level:22, name:'행성상성운',      cost:{type:'star',level:21,amount:2}, successRate:0.27, sellPrice:400000000, protectionCost:20, drop:null },
    { level:23, name:'백색왜성',        cost:{type:'item',key:ITEM_KEYS.MAGNETAR_FLARE,amount:12}, successRate:0.27, sellPrice:550000000, protectionCost:22, drop:null },
    { level:24, name:'흑색왜성',        cost:{type:'star',level:22,amount:1}, successRate:0.25, sellPrice:750000000, protectionCost:23, drop:null },
  ],
  track3: [
    { level:17, name:'청색초거성',      cost:{type:'hydrogen',amount:220000}, successRate:0.40, sellPrice:44500000,  protectionCost:9,  drop:null },
    { level:18, name:'적색초거성',      cost:{type:'hydrogen',amount:300000}, successRate:0.38, sellPrice:72000000,  protectionCost:10, drop:null },
    { level:19, name:'규소 연소',       cost:{type:'hydrogen',amount:400000}, successRate:0.35, sellPrice:120000000, protectionCost:12, drop:null },
    { level:20, name:'철핵 붕괴',       cost:{type:'hydrogen',amount:650000}, successRate:0.33, sellPrice:240000000, protectionCost:15, drop:null },
    { level:21, name:'II형 초신성',     cost:{type:'star',level:19,amount:1}, successRate:0.30, sellPrice:300000000, protectionCost:17, drop:null },
    { level:22, name:'초신성 잔해',     cost:{type:'star',level:21,amount:2}, successRate:0.27, sellPrice:400000000, protectionCost:20, drop:null },
    { level:23, name:'중성자별',        cost:{type:'item',key:ITEM_KEYS.MAGNETAR_FLARE,amount:12}, successRate:0.27, sellPrice:550000000, protectionCost:22, drop:null },
    { level:24, name:'펄사',            cost:{type:'star',level:22,amount:1}, successRate:0.25, sellPrice:750000000, protectionCost:23, drop:null },
  ],
  track4: [
    { level:17, name:'O형 초거성',      cost:{type:'hydrogen',amount:220000}, successRate:0.40, sellPrice:44500000,  protectionCost:9,  drop:null },
    { level:18, name:'밝은청색변광성',  cost:{type:'hydrogen',amount:300000}, successRate:0.38, sellPrice:72000000,  protectionCost:10, drop:null },
    { level:19, name:'LBV 대폭발',      cost:{type:'hydrogen',amount:400000}, successRate:0.35, sellPrice:120000000, protectionCost:12, drop:null },
    { level:20, name:'볼프-레이에 별',  cost:{type:'hydrogen',amount:650000}, successRate:0.33, sellPrice:240000000, protectionCost:15, drop:null },
    { level:21, name:'극초신성 / GRB',  cost:{type:'star',level:19,amount:1}, successRate:0.30, sellPrice:300000000, protectionCost:17, drop:null },
    { level:22, name:'블랙홀 형성',     cost:{type:'star',level:21,amount:2}, successRate:0.27, sellPrice:400000000, protectionCost:20, drop:null },
    { level:23, name:'항성질량 블랙홀', cost:{type:'item',key:ITEM_KEYS.MAGNETAR_FLARE,amount:12}, successRate:0.27, sellPrice:550000000, protectionCost:22, drop:null },
    { level:24, name:'X선 쌍성 블랙홀', cost:{type:'star',level:22,amount:1}, successRate:0.25, sellPrice:750000000, protectionCost:23, drop:null },
  ],
  track5: [
    { level:17, name:'극초거성',            cost:{type:'hydrogen',amount:220000}, successRate:0.40, sellPrice:44500000,  protectionCost:9,  drop:null },
    { level:18, name:'극대광도 별',         cost:{type:'hydrogen',amount:300000}, successRate:0.38, sellPrice:72000000,  protectionCost:10, drop:null },
    { level:19, name:'種族 III 거대별',     cost:{type:'hydrogen',amount:400000}, successRate:0.35, sellPrice:120000000, protectionCost:12, drop:null },
    { level:20, name:'쌍불안정',            cost:{type:'hydrogen',amount:650000}, successRate:0.33, sellPrice:240000000, protectionCost:15, drop:null },
    { level:21, name:'쌍불안정 초신성',     cost:{type:'star',level:19,amount:1}, successRate:0.30, sellPrice:300000000, protectionCost:17, drop:null },
    { level:22, name:'초대질량 블랙홀 씨앗', cost:{type:'star',level:21,amount:2}, successRate:0.27, sellPrice:400000000, protectionCost:20, drop:null },
    { level:23, name:'퀘이사',              cost:{type:'item',key:ITEM_KEYS.MAGNETAR_FLARE,amount:12}, successRate:0.27, sellPrice:550000000, protectionCost:22, drop:null },
    { level:24, name:'초대질량 블랙홀',     cost:{type:'star',level:22,amount:1}, successRate:0.25, sellPrice:750000000, protectionCost:23, drop:null },
  ],
};

// 트랙 종료 후 공통 구간 (+25~+29) — 5개 트랙이 다시 합류, track 무관
const POST_TRACK_STAGES = [
  { level:25, name:'우리 은하',           cost:{type:'item',key:ITEM_KEYS.HAWKING,amount:15}, successRate:0.35, sellPrice:400000000, protectionCost:23, drop:null },
