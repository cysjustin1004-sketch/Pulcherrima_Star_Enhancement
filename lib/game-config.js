...
const TRACKS = {
  ...
  track5: [
    ...
    { level:23, name:'초대질량 블랙홀',     cost:{type:'item',key:ITEM_KEYS.MAGNETAR_FLARE,amount:12}, successRate:0.27, sellPrice:550000000, protectionCost:22, drop:null },
    { level:24, name:'퀘이사',              cost:{type:'star',level:22,amount:1}, successRate:0.25, sellPrice:750000000, protectionCost:23, drop:null },
  ],
};
