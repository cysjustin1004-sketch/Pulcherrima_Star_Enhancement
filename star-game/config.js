...
const COMMON_STAGES = [
  ...
  },
  {
    ...
    sellPrice: 15000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 0, max: 2 },
  ...
  },
  {
    ...
    sellPrice: 90000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.HYPERGIANT_CORE, min: 0, max: 2 },
  ...
  },
  {
    ...
    sellPrice: 180000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.SUPERNOVA_GLOW, min: 0, max: 2 },
  ...
  },
  {
    ...
    sellPrice: 500000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.NEUTRON_CRUST, min: 0, max: 2 },
  ...
  },
  {
    ...
    sellPrice: 2000000,
    protectionCost: 2,
    drop: { key: ITEM_KEYS.PULSAR_SIGNAL, min: 0, max: 2 },
...
const TRACKS = {
  track1: [
    { level: 14, name: '적색왜성', subname: '프록시마 센타우리', type: 'M형 적색왜성',
      cost: { type: 'hydrogen', amount: 100000 }, successRate: 0.49, sellPrice: 5000000, protectionCost: 3,
      drop: { key: ITEM_KEYS.MAGNETAR_FLARE, min: 0, max: 2 },
    ...
    { level: 15, name: '플레어별', subname: 'TRAPPIST-1 급', type: '활동성 적색왜성',
      cost: { type: 'hydrogen', amount: 130000 }, successRate: 0.46, sellPrice: 10000000, protectionCost: 4,
      drop: { key: ITEM_KEYS.HAWKING, min: 0, max: 2 },
    ...
    { level: 16, name: '초장수명 주계열', subname: '캅테인의 별', type: '초장수명 주계열성',
      cost: { type: 'hydrogen', amount: 170000 }, successRate: 0.44, sellPrice: 20000000, protectionCost: 7,
      drop: { key: ITEM_KEYS.DARK_MATTER, min: 0, max: 2 },
    ...
    { level: 19, name: '헬륨 백색왜성', subname: '반 마넨의 별', type: '백색왜성',
      cost: { type: 'hydrogen', amount: 400000 }, successRate: 0.35, sellPrice: 120000000, protectionCost: 12,
      drop: null,
      codexDescription: '【거리: 약 14광년 / 반지름: 지구와 비슷】 청색왜성 단계 이후 남은 헬륨 핵이 식어가며 만들어지는 백색왜성. 1917년 발견된 반 마넨의 별은 동반성 없이 홀로 떠 있는 것으로 확인된 최초의 백색왜성이다.' },
    ...
    { level: 21, name: '흑색왜성', subname: '완전 소등 · 이론상', type: '이론적 최종 잔해',
      cost: { type: 'star', level: 19, amount: 1 }, successRate: 0.30, sellPrice: 300000000, protectionCost: 17,
      drop: null,
  ...
  track2: [
    ...
    { level: 17, name: '수평가지', subname: '거문고자리 RR', type: '헬륨 안정 연소기',
      cost: { type: 'hydrogen', amount: 220000 }, successRate: 0.40, sellPrice: 44500000, protectionCost: 9,
      drop: null,
      codexDescription: '【거리: 약 840광년 / 맥동 주기: 약 13.6시간】 헬륨 섬광 이후 별이 안정적으로 헬륨을 태우는 단계. 거문고자리 RR은 이런 수평가지 별의 대표 원조 격으로, 정확한 맥동 주기를 이용해 성단까지의 거리를 재는 표준광원으로 쓰인다.' },
    { level: 18, name: '점근거성가지', subname: '세페우스자리 델타', type: 'AGB 별',
      cost: { type: 'hydrogen', amount: 300000 }, successRate: 0.38, sellPrice: 72000000, protectionCost: 10,
      drop: null,
      codexDescription: '【거리: 약 890광년 / 맥동 주기: 약 5.4일】 헬륨마저 고갈되면 다시 팽창하며 맥동하는 거대한 별이 된다. 세페우스자리 델타는 밝기가 주기적으로 오르내리는 맥동 변광성의 원조 격 천체로, 이런 규칙적인 맥동은 이 진화 단계의 대표적인 특징이다.' },
  ...
  track3: [
    ...
    { level: 19, name: 'II형 초신성', subname: '카시오페이아자리 A', type: 'II형 초신성',
      cost: { type: 'hydrogen', amount: 400000 }, successRate: 0.35, sellPrice: 120000000, protectionCost: 12,
      drop: null,
      codexDescription: '【거리: 약 11,000광년 / 폭발 시점: 약 340년 전 추정】 카시오페이아자리에 있는 초신성 잔해. 폭발 당시 지구에서는 눈에 띄게 관측되지 않았지만, 지금은 X선·적외선 관측을 통해 팽창하는 충격파 껍질 구조가 상세히 밝혀진 대표적인 II형 초신성 잔해다.' },
...
const SHOP_ITEMS = [
  {
    id: 'warp_9',
    name: '+9강 도약권',
    desc: 'FU 오리온 폭발(+9) 상태로 시작합니다. (성공 확률 100%)',
    price: 800000,
    type: 'warp',
    targetLevel: 9,
    successRate: 1.00,
  },
  {
    id: 'warp_13',
    name: '+13강 도약권',
    desc: '중심 수소 고갈(+13) 상태로 시작합니다. (성공 확률 80%, 실패 시 수소만 소모)',
    price: 5000000,
    type: 'warp',
    targetLevel: 13,
    successRate: 0.80,
  },
  {
    id: 'warp_14',
    name: '+14강 도약권',
    desc: '트랙 진입 직후(+14) 상태로 시작합니다. 트랙은 무작위로 배정됩니다. (성공 확률 60%, 실패 시 수소만 소모)',
    price: 7500000,
    type: 'warp',
    targetLevel: 14,
    successRate: 0.60,
  },
  {
    id: 'warp_15',
    name: '+15강 도약권',
    desc: '트랙 두 번째 단계(+15) 상태로 시작합니다. 트랙은 무작위로 배정됩니다. (성공 확률 40%, 실패 시 수소만 소모)',
    price: 10000000,
    type: 'warp',
    targetLevel: 15,
    successRate: 0.40,
