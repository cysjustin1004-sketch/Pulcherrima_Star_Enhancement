...
const COMMON_STAGES = [
  ...
  },
  {
    ...
    subname: 'HL 타우리',
    type: '원시별',
    cost: { type: 'hydrogen', amount: 1500 },
    successRate: 0.90,
    sellPrice: 1600,
    protectionCost: 0,
    drop: null,
  ...
  },
  {
    ...
    subname: 'FS 타우리',
    type: 'T타우리형 별',
    cost: { type: 'hydrogen', amount: 3000 },
    successRate: 0.85,
    sellPrice: 10000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
  ...
  },
  {
    ...
    subname: '강착 폭발',
    type: '강착 폭발 현상',
    cost: { type: 'hydrogen', amount: 5000 },
    successRate: 0.80,
    sellPrice: 20000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
  ...
  },
  {
    ...
    type: '영년 주계열성',
    cost: { type: 'hydrogen', amount: 10900 },
    successRate: 0.80,
    sellPrice: 35100,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
  ...
  },
  {
    ...
    subname: '태양',
    type: '주계열성',
    cost: { type: 'hydrogen', amount: 20000 },
    successRate: 0.75,
    sellPrice: 160000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
  ...
  },
  {
    ...
    subname: '흑점 · 플레어',
    type: '자기 활동기',
    cost: { type: 'hydrogen', amount: 35000 },
    successRate: 0.70,
    sellPrice: 350000,
    protectionCost: 1,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
  ...
  },
  {
    ...
    subname: '맥동 거성 · ξ Hya',
    type: '핵연료 고갈기',
    cost: { type: 'hydrogen', amount: 55000 },
    successRate: 0.70,
    sellPrice: 1000000,
    protectionCost: 2,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
  ...
  },
  {
    ...
    subname: '알데바란 급',
    type: '적색거성가지 진입',
    cost: { type: 'hydrogen', amount: 180000 },
    successRate: 0.60,
    sellPrice: 7500000,
    protectionCost: 4,
    drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
...
const TRACKS = {
  track1: [
    { level: 17, name: '적색왜성', subname: '프록시마 센타우리', type: 'M형 적색왜성',
      cost: { type: 'hydrogen', amount: 300000 }, successRate: 0.55, sellPrice: 20000000, protectionCost: 9,
      drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
    ...
    { level: 18, name: '플레어별', subname: 'TRAPPIST-1 급', type: '활동성 적색왜성',
      cost: { type: 'hydrogen', amount: 500000 }, successRate: 0.50, sellPrice: 30000000, protectionCost: 10,
      drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
    ...
    { level: 19, name: '초장수명 주계열', subname: '붉은 왜성', type: '초장수명 주계열성',
      cost: { type: 'hydrogen', amount: 800000 }, successRate: 0.50, sellPrice: 47500000, protectionCost: 12,
      drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
    ...
    { level: 20, name: '청색왜성化', subname: '수축·청색화', type: '이론적 진화 단계',
      cost: { type: 'hydrogen', amount: 1500000 }, successRate: 0.45, sellPrice: 68300000, protectionCost: 15,
      drop: { key: ITEM_KEYS.STELLAR_WIND, min: 1, max: 3 },
    ...
    { level: 21, name: '청색왜성', subname: '이론상 말기', type: '이론적 천체',
      cost: { type: 'star', level: 19, amount: 1 }, successRate: 0.40, sellPrice: 101000000, protectionCost: 17,
      drop: null,
    ...
    { level: 22, name: '헬륨 백색왜성', subname: '시리우스 B 급', type: '백색왜성',
      cost: { type: 'star', level: 21, amount: 2 }, successRate: 0.40, sellPrice: 160000000, protectionCost: 20,
      drop: null,
    ...
    { level: 23, name: '백색왜성 냉각', subname: '식어가는 잔해', type: '냉각 백색왜성',
      cost: { type: 'item', key: ITEM_KEYS.STELLAR_WIND, amount: 8 }, successRate: 0.40, sellPrice: 230000000, protectionCost: 22,
      drop: null,
    ...
    { level: 24, name: '흑색왜성', subname: '완전 소등 · 이론상', type: '이론적 최종 잔해',
      cost: { type: 'star', level: 22, amount: 1 }, successRate: 0.40, sellPrice: 300000000, protectionCost: 23,
      drop: null,
...
const POST_TRACK_STAGES = [
  { level: 25, name: '우리 은하', subname: '은하수 · Milky Way', type: '막대나선은하',
    cost: { type: 'item', key: ITEM_KEYS.STELLAR_WIND, amount: 15 }, successRate: 0.35, sellPrice: 400000000, protectionCost: 23,
    drop: null,
...
// ============================================================
// 상점 아이템 (이지 모드 가격) — 도약권은 전부 공통 구간(0~16) 내
// ============================================================
const SHOP_ITEMS = [
  {
    id: 'warp_9',
...
const RECIPES = [
  {
    id: 'r1',
    inputs: [{ key: ITEM_KEYS.STELLAR_WIND, amount: 5 }],
    output: { type: 'protection', amount: 1 },
    desc: '항성풍 파편 5개 → 붕괴 방지권 1개',
  },
  {
    id: 'r2',
    inputs: [{ key: ITEM_KEYS.HYPERGIANT_CORE, amount: 3 }],
    output: { type: 'protection', amount: 1 },
    desc: '극초거성 핵 파편 3개 → 붕괴 방지권 1개',
  },
  {
    id: 'r3',
    inputs: [{ key: ITEM_KEYS.SUPERNOVA_GLOW, amount: 2 }],
    output: { type: 'star', trackRelative: 1 },
    desc: '초신성 잔광 2개 → 내 트랙 2번째 단계 별 1개',
  },
  {
    id: 'r4',
    inputs: [{ key: ITEM_KEYS.NEUTRON_CRUST, amount: 3 }],
    output: { type: 'protection', amount: 2 },
    desc: '중성자별 껍질 조각 3개 → 붕괴 방지권 2개',
  },
  {
    id: 'r5',
  ...
  {
    id: 'r9',
    inputs: [{ key: ITEM_KEYS.DARK_MATTER, amount: 3 }],
    output: { type: 'protection', amount: 9 },
    desc: '암흑 물질 조각 3개 → 붕괴 방지권 9개',
  },
];
...
const IMPORTANT_ITEM_WARNINGS = {
  ...
  [ITEM_KEYS.DARK_MATTER]:    '[경고] 조합 재료(3개) — 함부로 교환하지 마세요!',
};
